...
if __name__ == '__main__':
    ...
    np.savetxt("hard_mdp_test_gamma_data/err.csv", output, delimiter=",")
    np.savetxt("hard_mdp_test_gamma_data/gammas.csv", gammas, delimiter=",")
    np.savetxt("hard_mdp_test_gamma_data/iters.csv", niters, delimiter=",")
    ...
    plt.tight_layout()
    plt.savefig('test_gamma_plt_200_rep,slope = {}.png'.format(slopes), dpi=1000)

...
def log_log_error(mdp,gamma,delta,step = 1,start_iter = 1500,end_iter = 1500,n_traj = 400):
    drrl_mlmc = DR_RL_MLMC(mdp,delta,gamma)
    #K = 640*np.e*np.log(5)/(1-drrl_mlmc.gamma)**3
    #eps = 4/(1-drrl_mlmc.gamma)
    #lr = lambda x: eps/(x+K)
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.savefig('log-log_err-iter 500-5000 delta=0.1 gammas = {}.png'.format(gammas), dpi=1000)
